...
public class Jtable1 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Entrer Your First Name");

        jLabel2.setText("Enter Middle Name");

        jLabel3.setText("EnterLast Name");
        ...
        jButton5.setText("Delete all rows");
...
if(rows==0)
model.addRow(new Object[]{fn,mn,ln});
else if(rows>=1)
    model.addRow(new Object[]{fn,mn,ln});
...
if(row>0)
{
    for(int i=0;i<row;i++)
    {
        JOptionPane.showMessageDialog(this,"Removing all rows");
        model.removeRow(0);
    }
}
// TODO add your handling code here:
...
try{
   ...
   DriverManager.getConnection("jdbc:mysql://localhost:3306/school","Kishore","kishore");
  ...
  String nSalary=rs.getString("salary");
   ...
   System.out.println(ntNo+"|"+ntName+"|"+ntAddress+"|"+nSalary+"|"+nDept_no+"|"+ndoj);
   model.addRow(new Object[]{ ntNo,ntName,ntAddress,nSalary,nDept_no,ndoj});
   }
   }
